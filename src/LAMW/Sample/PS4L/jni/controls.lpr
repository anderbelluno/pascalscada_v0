library controls;        //[by LAMW [GUI]:29/12/2025 16:11:38]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     gjClass:= (curEnv^).FindClass(curEnv, 'com/br/gp2e/ps4l/Controls');
     gjClass:= (curEnv^).NewGlobalRef(curEnv, gjClass);
     rc := RegisterNativeMethods(curEnv, 'com/br/gp2e/ps4l/Controls');
     if (rc <> JNI_OK) then result := rc;
  end;
  gjClassName:= 'com/br/gp2e/ps4l/Controls';
...
exports
  ...
  pEditTextOnActionIconTouchUp name 'Java_com_br_gp2e_ps4l_Controls_'
  ...
  pOnTCPSocketClientConnected name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnTCPSocketClientConnected',
  pOnTCPSocketClientFileSendProgress name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnTCPSocketClientFileSendProgress',
  pOnTCPSocketClientFileSendFinished name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnTCPSocketClientFileSendFinished',
  pOnTCPSocketClientFileGetProgress name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnTCPSocketClientFileGetProgress',
  pOnTCPSocketClientFileGetFinished name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnTCPSocketClientFileGetFinished',
  pOnTCPSocketClientDisConnected name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnTCPSocketClientDisConnected',
  pOnTimer name 'Java_com_br_gp2e_ps4l_Controls_pOnTimer',
  pAppOnCreate name 'Java_com_br_gp2e_ps4l_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_br_gp2e_ps4l_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_br_gp2e_ps4l_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_br_gp2e_ps4l_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_br_gp2e_ps4l_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_br_gp2e_ps4l_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_br_gp2e_ps4l_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_br_gp2e_ps4l_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_br_gp2e_ps4l_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_br_gp2e_ps4l_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_br_gp2e_ps4l_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_br_gp2e_ps4l_Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_br_gp2e_ps4l_Controls_pOnDraw',
  pOnTouch name 'Java_com_br_gp2e_ps4l_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_br_gp2e_ps4l_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_br_gp2e_ps4l_Controls_pOnDown',
  pOnUp name 'Java_com_br_gp2e_ps4l_Controls_pOnUp',
  pOnClick name 'Java_com_br_gp2e_ps4l_Controls_pOnClick',
  pOnLongClick name 'Java_com_br_gp2e_ps4l_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_com_br_gp2e_ps4l_Controls_pOnDoubleClick',
  pOnChange name 'Java_com_br_gp2e_ps4l_Controls_pOnChange',
  pOnChanged name 'Java_com_br_gp2e_ps4l_Controls_pOnChanged',
  pOnEnter name 'Java_com_br_gp2e_ps4l_Controls_pOnEnter',
  pOnBackPressed name 'Java_com_br_gp2e_ps4l_Controls_pOnBackPressed',
  pOnDone name 'Java_com_br_gp2e_ps4l_Controls_pOnDone',
  pOnSearch name 'Java_com_br_gp2e_ps4l_Controls_pOnSearch',
  pOnNext name 'Java_com_br_gp2e_ps4l_Controls_pOnNext',
  pOnGo name 'Java_com_br_gp2e_ps4l_Controls_pOnGo',
  pOnClose name 'Java_com_br_gp2e_ps4l_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_br_gp2e_ps4l_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_br_gp2e_ps4l_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_br_gp2e_ps4l_Controls_pOnLostFocus',
  pOnFocus name 'Java_com_br_gp2e_ps4l_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_br_gp2e_ps4l_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_br_gp2e_ps4l_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_com_br_gp2e_ps4l_Controls_pOnRunOnUiThread';
