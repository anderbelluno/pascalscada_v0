...
zipalign -v -p 4 /files/pascalscada_v0/src/LAMW/Sample/PS4L/build/outputs/apk/release/PS4L-universal-release-unsigned.apk /files/pascalscada_v0/src/LAMW/Sample/PS4L/build/outputs/apk/release/PS4L-universal-release-unsigned-aligned.apk
